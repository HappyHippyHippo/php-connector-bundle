...
use Hippy\Connector\Tests\Functional\Connector\Mocks\Config\Connector;
use Hippy\Connector\Tests\Functional\Connector\Mocks\Config\LoggerHandler;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;
use Psr\Http\Message\StreamInterface;

/** @coversDefaultClass \Hippy\Connector\Tests\Functional\Connector\Mocks\Config\Connector */
class ConfigConnectorTest extends TestCase
{
    ...
    public function testValidResponse(): void
    {
        ...
        $this->client
            ...
            ->with($this->callback(function (Request $request) {
                return $request->getUri()->getPath() == '__config'
