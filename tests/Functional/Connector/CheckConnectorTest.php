...
use Hippy\Connector\Connector\Check\ResponseHandler;
...
use Hippy\Connector\Tests\Functional\Connector\Mocks\Check\Connector;
use Hippy\Connector\Tests\Functional\Connector\Mocks\Check\LoggerHandler;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;
use Psr\Http\Message\StreamInterface;

/** @coversDefaultClass \Hippy\Connector\Tests\Functional\Connector\Mocks\Check\Connector */
class CheckConnectorTest extends TestCase
{
    ...
    {
        $request = new RequestModel(true, ['header1' => '__dummy_header_value__']);
        ...
        $this->client
            ...
            ->with($this->callback(function (Request $request) {
                return $request->getUri()->getPath() == '__check'
                    && $request->getUri()->getQuery() == 'deep=1'
