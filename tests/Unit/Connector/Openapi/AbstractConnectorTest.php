...
/** @coversDefaultClass \Hippy\Connector\Connector\Openapi\AbstractConnector */
class AbstractConnectorTest extends ConnectorTester
{
    ...
    {
        $this->assertEquals(3, $this->connector->getEndpointCode());
    }
     ...
     */
    public function testDontThrowOnServiceUnavailable(): void
    {
        $this->handleFailureOnPossibleStatusCodeTester(
            $this->connector,
            $this->requestModel,
    ...
    {
        $this->handleFailureOnUnexpectedStatusCodeTester(
            $this->connector,
            $this->requestModel,
